...
infection: tools/infection tools/infection.pubkey
	phpdbg -qrr ./tools/infection --no-interaction --formatter=progress --min-msi=64 --min-covered-msi=64 --only-covered --ansi
.PHONY: infection
...
tools/infection: tools/infection.pubkey
	curl -Ls https://github.com/infection/infection/releases/download/0.9.0-beta.2/infection.phar -o tools/infection && chmod +x tools/infection

tools/infection.pubkey:
	curl -Ls https://github.com/infection/infection/releases/download/0.9.0-beta.2/infection.phar.pubkey -o tools/infection.pubkey
